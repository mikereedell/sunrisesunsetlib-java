...
public class SunsetCalculatorTest extends BaseTestCase {
    ...
    public void testGetRightAscensionInHours() {
        ...
        assertTrue(getErrorMessage(raInHours, actualRAInHours), raInHours.compareTo(actualRAInHours) == 0);
    }
    ...
    public void testGetSinOfSunDeclination() {
        ...
        assertTrue(getErrorMessage(sinOfSunDec, actualSinOfSunDec), sinOfSunDec.compareTo(actualSinOfSunDec) == 0);
    }
    ...
    public void testGetCosineOfSunLocalHourAngle() {
        ...
        assertTrue(getErrorMessage(cosineSunLocalHour, actualCosineSunLocalHour), cosineSunLocalHour
